    ...
    <div className="w-full max-w-5xl mx-auto pb-12 font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
           ...
           <p className="text-gray-500 font-medium mt-1">Configure your domains to mount Workly directly inside your app.</p>
        </div>
      </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mb-8 flex items-start gap-4 shadow-sm">
        ...
        <div>
          <h3 className="font-bold text-amber-900 text-lg mb-1">Embed the Workly panel directly in your HR platform.</h3>
